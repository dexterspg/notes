...
public class QuestionService {
    ...
    public ResponseEntity<List<QuestionWrapper>> getQuestionsFromId(List<Integer> questionIds) {
        ...
        questionIds.stream()
            .forEach(id -> questions.add(questionDao.findById(id).get()));
    ...
    public ResponseEntity<Integer> getScore(List<Response> responses) {
        ...
        .filter(response -> {
            ...
            return response.getResponse().equals(question.getRightAnswer());
        })
        .count();

        return new ResponseEntity<>((int) right, HttpStatus.OK);
    }
}
